...
$(document).ready(function () {
    ...
    $('#avaliacao_fisica_body_composition_attributes_peso_atual, #avaliacao_fisica_body_composition_attributes_triciptal, #avaliacao_fisica_body_composition_attributes_subescapular, #avaliacao_fisica_body_composition_attributes_peitoral, #avaliacao_fisica_body_composition_attributes_axilar, #avaliacao_fisica_body_composition_attributes_supra_iliaca, #avaliacao_fisica_body_composition_attributes_abdominal, #avaliacao_fisica_body_composition_attributes_coxa').keyup(function () {
        ...
        if ($('#avaliacao_fisica_body_composition_attributes_protocolo_pollock').is(":checked")) {
            if (aluno_sexo == 'Masculino') {
                if ($('#avaliacao_fisica_body_composition_attributes_peitoral').is(":filled") && $('#avaliacao_fisica_body_composition_attributes_abdominal').is(":filled") && $('#avaliacao_fisica_body_composition_attributes_coxa').is(":filled") && $('#avaliacao_fisica_body_composition_attributes_peso_atual').is(":filled")) {
                ...
                if ($('#avaliacao_fisica_body_composition_attributes_triciptal').is(":filled") && $('#avaliacao_fisica_body_composition_attributes_supra_iliaca').is(":filled") && $('#avaliacao_fisica_body_composition_attributes_coxa').is(":filled") && $('#avaliacao_fisica_body_composition_attributes_peso_atual').is(":filled")) {
        ...
        else if ($('#avaliacao_fisica_body_composition_attributes_protocolo_mcardle').is(":checked")) {
            // TODO
        }
    });

    // NEUROMOTORES
    $('#avaliacao_fisica_body_composition_attributes_peso_atual, #avaliacao_fisica_neuromotor_attributes_abdominal_repeticoes').keyup(function () {
        abdominais = $(this).val();
        aluno_sexo = $('#aluno_sexo').val();
        aluno_idade = $('#aluno_idade').val();
    ...
    $('#avaliacao_fisica_cardiorespiratory_assessment_attributes_distancia_total').keyup(function () {
