function avaliacao_cardiorespiratoria_pollock(aluno_sexo, aluno_idade, VO2max) {
...
function avaliacao_cardiorespiratoria_cooper(aluno_sexo, aluno_idade, distancia_total_percorrida) {
    if(aluno_sexo == 'Masculino') {
      if(aluno_idade <= 19) {
