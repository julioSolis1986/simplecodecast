function cardiorespiratory_assessment_pollock(aluno_sexo, aluno_idade, VO2max) {
...
function cardiorespiratory_assessment_cooper(aluno_sexo, aluno_idade, distancia_total_percorrida) {
    if (aluno_sexo == 'Masculino') {
        if (aluno_idade <= 19) {
