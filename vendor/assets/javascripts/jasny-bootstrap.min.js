...
!function (e) {
    ...
    t.prototype = {constructor: t, replaceSelect: function () {
    ...
    }, e.fn.typeahead.defaults = {source: [], items: 8, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', ajaxdelay: 400, minLength: 1}, e.fn.typeahead.Constructor = t, e.fn.typeahead.noConflict = function () {
