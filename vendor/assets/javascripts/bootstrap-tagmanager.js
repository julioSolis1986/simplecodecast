...
(function ($) {
    ...
    $.fn.tagsManager = function (options, tagToManipulate) {
        ...
        var pushTag = function (tag) {
            ...
            var tlisLowerCase = $.map(tlis, function (elem) {
            ...
            if (alreadyInList) {
                ...
                var html = '<div class="row-fluid"><span class="span12 ' + tagClasses() + '" id="' + newTagId + '">';
                html += '<span>' + escaped + '</span>';
                html += '<a href="#" class="tm-tag-remove" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
                html += tagManagerOptions.tagCloseIcon + '</a></span></div> ';
                var $el = $(html);
